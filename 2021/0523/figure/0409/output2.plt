...
#set size ratio -1
plot "RidgeLine.txt" using 1:2 with lines linewidth 1.0 title "Initial Boundary Line","AmendLine.txt" using 1:2 with lines linewidth 1.0 title "Computed Surface", "WireImage.txt" u 1:2 w l title "Initial Boundary Line", "COND.txt" u 1:2 title "COND_POS"
...
plot "RidgeLine.txt" using 1:3 with lines linewidth 1.0 title "Initial Boundary Line","AmendLine.txt" using 1:3 with lines linewidth 1.0 title "Computed Surface", "WireImage.txt" u 1:3 w l title "Initial Boundary Line", "COND.txt" u 1:3 title "COND_POS"
...
#set size ratio -1
plot "Pattern2.txt" using 1:2 with lines linewidth 1.0 title "Pattern Boundary Line","Pattern2.txt" using 3:4 with lines linewidth 1.0 title "Pattern Boundary Line"
set terminal pngcairo enhanced crop
set output "Patt2.png"
